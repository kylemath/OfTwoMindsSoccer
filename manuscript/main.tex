...
% --- Tip Box Environments (using savebox for robust fcolorbox) ---
...
\newenvironment{keeperbox}{%
  ...
  \end{minipage}%
  \end{lrbox}%
  \fcolorbox{keeperblue}{boxbg}{\usebox{\tipboxcontent}}%
  \smallskip}
...
\newenvironment{strikerbox}{%
  ...
  \end{minipage}%
  \end{lrbox}%
  \fcolorbox{strikerred}{boxbg2}{\usebox{\tipboxcontent}}%
  \smallskip}
...
\newenvironment{caveatbox}{%
  ...
  \end{minipage}%
  \end{lrbox}%
  \fcolorbox{muted}{white}{\usebox{\tipboxcontent}}%
  \smallskip}
...
\bigskip
\noindent\textbf{Keywords:} penalty kick, of two minds, shared neural subspaces, motor interference, action selection, pre-commitment, decision making in sport, sports neuroscience
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig5_precommit.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/empirical_pred1_conversion_by_mismatch.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/empirical_pred2_sequential.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/empirical_pred4_expertise.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/empirical_pred5_centrality.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/empirical_pred6_congruence.png}
